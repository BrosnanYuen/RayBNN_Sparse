...
pub fn integer_histogram<Z: arrayfire::RealNumber + arrayfire::ReduceByKeyInput>(
	input: &arrayfire::Array<Z>,

    bins: &mut arrayfire::Array<Z>,
    counts: &mut arrayfire::Array<i32>
    ) {
    ...
    (*bins, *counts) = arrayfire::sum_by_key(&sorted, &ones, 0);
